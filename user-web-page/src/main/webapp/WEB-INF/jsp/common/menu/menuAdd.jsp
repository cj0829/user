...
<head>
  ...
  <title>添加菜单管理--${system_name}</title>  
</head>
<body>
<!-- start 内容 -->
<form action="#" method="post" name="menuForm" id="menuForm" onsubmit="return saveMenu(this)">
<div class="e-tabbox">
	<!-- start one -->
		...
		<div class="e-form-mod-bd">
			<table class="e-form-tab" width="100%">
				<tr>
					...
					<td class="e-form-td">
						<input class="easyui-textbox inp" name="name" style="width:230px;" type="text"/>
					</td>
				</tr>
				<tr>
					<th class="e-form-th" style="width:136px;" >
					...
					<td class="e-form-td">
						...
						<input name="parentId" value="${parentId }" style="width:230px;" type="hidden"/>
					</td>
				</tr>
				<tr>
					<th class="e-form-th" style="width:136px;" >
					...
					<td class="e-form-td">
						<input name="display" type="checkbox" value="2" />
					</td>
				</tr>
					...
					<td class="e-form-td">
						<div class="main-search-right">
	                		...
	                		<core:combogrid toolbarId="functionPointToolbar" id="functionPointId" name="functionPoint" idField="id" panelWidth="460px" textField="name"
			                 ...
			                 url="${cxt}/functionPoint/ajax/paged.action" style="width:200px;height:25px;"/>
				...
				<tr>
					...
					<td class="e-form-td">
						<input class="easyui-textbox inp" name="rank" style="width:230px;" type="text"/>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="e-form-td">
						<input class="easyui-textbox inp" name="remark" style="width:230px;" type="text"/>
					</td>
				</tr>
			</table>
		</div>
...
<script type="text/javascript"> 
	...
	//提交表单的方法
	function saveMenu(form1){
		if($("#menuForm").form("validate")){
			var params=jQuery("#menuForm").serialize();
			/* params=params+"&functionPoint="+$("#functionPointId").combogrid("getValue"); */
			jQuery.post("${cxt}/menu/ajax/add.action",params,function call(data){
				if(data.status){
					showMsg("info","添加菜单管理成功");
					top.callbackPage();
					cancelWindow();
				}else{
					if(data.message){
