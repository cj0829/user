		...
		<div class="e-form-mod-bd">
			<table class="e-form-tab" width="100%">
				<tr>
					...
					<td class="e-form-td">
						<input class="easyui-textbox inp" id="" name="" data-options="" maxlength="0" style="width:230px;" type="text"/>
					</td>
				</tr>
				<tr>
					<th class="e-form-th" style="width:136px;" >
				...
				<tr>
					...
					<td class="e-form-td">
						<input class="easyui-textbox inp" id="mailTemplate" name="mailTemplate" data-options="" maxlength="0" style="width:230px;" type="text"/>
					</td>
				</tr>
				<tr>
					<th class="e-form-th" style="width:136px;" >
					...
					<td class="e-form-td">
						<input class="easyui-textbox inp" id="smsTemplate" name="smsTemplate" data-options="" maxlength="0" style="width:230px;" type="text"/>
					</td>
				</tr>
				<tr>
					<th class="e-form-th" style="width:136px;" >
					...
					<td class="e-form-td">
						<input class="easyui-textbox inp" id="remark" name="remark" data-options="" maxlength="0" style="width:230px;" type="text"/>
					</td>
				</tr>
			</table>
		</div>
