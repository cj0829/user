...
<form action="#" method="get" name="userForm" id="userForm" onsubmit="return updateUserMore(this)">
	<table class="e-form-tab" width=100%>
		<tr>
			<th class="e-form-th" style="width:80px;" ><label>手机号</label></th>
			<td class="e-form-td">
			<input class="easyui-textbox" id="mobile" name="mobile"  data-options="" value="${userMore.mobile}" style="width:200px;height: 25px;" type="text"/>
			</td>
		</tr>
		<tr>
			<th class="e-form-th"><label>固定电话</label></th>
			<td class="e-form-td">
