		...
		<table width=100%;>
			<tr>
				<td class="veraT"><div class="colorc" id="">
					<label class="mr8 lab" style="width:60px;">机构:</label><user:agenciesgrid id="agenciesId" name="agenciesId" value="${agenciesId}" style="width:115px; height:27px;"/><br/>
					上传压缩包，压缩包里的图片名，作为用户名。(最大压缩包的内容，只提供200M)
				</div></td>
...
WebUploaderError.put("Q_TYPE_DENIED","请选择正确格式的压缩包！");
WebUploaderError.put("F_EXCEED_SIZE","请上传小于200M的压缩包！");
WebUploaderError.put("Q_EXCEED_SIZE_LIMIT","请上传小于200M的压缩包！");
...
var waitingbar;
	$(function(){
		...
		var uploader = WebUploader.create({
			...
			server : "${cxt}/mobile/fKBlackList/ajax/upload/blackFace.action",
			duplicate : true,
