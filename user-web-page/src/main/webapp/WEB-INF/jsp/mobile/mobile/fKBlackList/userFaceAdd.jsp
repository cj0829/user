...
<head>
  <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	...
	<%@include file="/include/webuploader.jsp"%>
 	<title>上传黑名单人脸--${system_name}</title>  
 	<style>
		img {
			width: auto\9;
			height: auto;
		...
		<div title="第一张图" style="height:310px;">
			<div class="main-formbox">
            	<div class="e-tabbox">
					...
					<tr><th class="e-form-th" style="width:92px;"></th>
						<td class="e-form-td">
						<img id="target1" src="${fKBlackList.facepath}"/>
					</td>
					<td>
					</td>
					</tr>
...
<script type="text/javascript">
 	...
 	var uploader1 = WebUploader.create({
 		...
 		server : "${cxt}/mobile/fKBlackList/ajax/collectFace.action?fKBlackListId=${fKBlackList.id}",
 		fileVal : "image",
 		duplicate : true,
 		fileNumLimit : 1,
