...
<body> 
<div class="e-tabbar">
	<a class="t-btn" href="${cxt}/school/user/preUpdate.action?id=${userId}" ><span class="btntxt">主要</span></a>
	<core:security code="0201409">
	<a class="t-btn" href="${cxt}/school/user/preUpdateResetPassword.action?userId=${userId}" ><span class="btntxt">密码</span></a>
	</core:security>
	<a class="t-btn curr" href="javascript:;" >用户头像</a>
	<core:security code="0201411">
	<a class="t-btn" href="${cxt}/school/user/preUserPreferences.action?userId=${userId}" ><span class="btntxt">首选项</span></a>
	</core:security>
...
var waitingBar=WaitingBar.getWaitingbar("login","正在上传头像，请等待...");
