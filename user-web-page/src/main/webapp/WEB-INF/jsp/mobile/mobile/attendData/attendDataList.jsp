			...
			<table width="100%">
				<tr>
					...
					<ul>
						...
						<li class="e-search-td"><label class="mr8 lab" style="width:90px;">目标id:</label><input id="targetId" class="main-inp" type="text" type="text"style="width:115px; height:25px;"/></li>
						...
						<li class="e-search-td"><label class="mr8 lab" style="width:90px;">记录类型:</label><input id="logType" class="main-inp" type="text" type="text"style="width:115px; height:25px;"/></li>
					</ul>
					</td>
...
<script type="text/javascript">
	$(function(){
		$("#datagridList").datagrid({
			nowrap: true,
			url:"${cxt}/mobile/attendData/ajax/list.action",
			collapsible:true,
			showfolder:true,
			border:false,
			fitColumns:true,
			...
			columns:[[
				{field:"ck",checkbox:true},
						...
						{title:"打卡记录",field:"ac_attenddata",width:150},
	...
	function addAttendData(){
		$("#win").window({
			...
			width:800,
			height:600,
			iframe:"${cxt}/mobile/attendData/preAdd.action",
			modal:true
		});
	}
	...
	function editAttendData(id){
		$("#win").window({
			...
			width:800,
			height:600,
			iframe:"${cxt}/mobile/attendData/preUpdate.action?id="+id,
			modal:true
		});
	}
	...
	function deleteAttendDatas(){
        ...
        if(confirm("确认是否删除?")){
			jQuery.post("${cxt}/mobile/attendData/ajax/delete.action",param, function call(data){
	...
	function deleteAttendData(id){
	     if(confirm("确认是否删除?")){
			...
			jQuery.post("${cxt}/mobile/attendData/ajax/delete.action",{"ids":id}, function call(data){
