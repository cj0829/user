...
<div>
	<!--内容开始-->
	<form action="#" method="get" name="dactyForm" id="dactyForm" onsubmit="return saveDacty()">
	<div id="easyui-tabs">
		<!--tab开始-->
	...
	function saveDacty(){
		try{
			if($("#dactyForm").form("validate")){
				WaitingBar.getWaitingbar("adddacty","数据添加中，请等待...","${jsPath}").show();
				var params=jQuery("#dactyForm").serialize();
				jQuery.post("${cxt}/mobile/dacty/ajax/add.action",params,function call(data){
					WaitingBar.getWaitingbar("adddacty").hide();
					if(data.status){
