			...
			<div class="main-formbox">
            	<div class="e-tabbox">
                	...
                	<tr><th class="e-form-th" style="width:92px;">人脸名称</th>
						<td class="e-form-td">
							<input class="easyui-textbox" type="text"  name="userName" id="userName" value="${userFace.loginName}"/>
					...
					<tr><th class="e-form-th" style="width:92px;">人脸图片张图</th>
						<td class="e-form-td">
						<img id="target1" src="${userFace.facepath1}"/>
					</td>
					</tr>
					</table>
				</div>
...
<script type="text/javascript">
 	...
 	var uploader1 = WebUploader.create({
 		...
 		server : "${cxt}/face/userFacedb/ajax/updateCollectFace.action",
 		fileVal : "image",
 		duplicate : true,
 		fileNumLimit : 1,
