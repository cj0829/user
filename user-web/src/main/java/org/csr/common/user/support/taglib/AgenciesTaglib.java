 ...
 *        公用方法描述： <br/>
 */
public class AgenciesTaglib extends TagSupport {
	...
	private String url = "/agencies/ajax/findDropDownList.action";
	...
	private String columns = "{field:'ck',checkbox:true},{field:'id',title:'机构ID',width:70},{field:'name',title:'姓名',width:100}";
	...
	public int doStartTag() throws JspException {
		try {
			...
			if(ObjUtil.isEmpty(toolbarId)){
				...
				htmlStr.append("<button class=\"operate-btn mr5\" type=\"button\" onclick=\"$('#"+id+"').combogrid('grid').datagrid('load',{name:$('#"+id+"_nameinp').val()});\">查询</button>");
				...
				htmlStr.append("</dd><dd><label class=\"lab\" style=\"width:60px;\">名称:</label><input id=\""+id+"_nameinp\" style=\"width:100px; height:22px;\" type=\"text\"/>");
