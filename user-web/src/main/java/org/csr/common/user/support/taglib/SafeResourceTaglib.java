 ...
 *        公用方法描述： <br/>
 */
public class SafeResourceTaglib extends TagSupport {
	...
	private String url = "/safeResourceCollection/ajax/findDropDownList.action";
	...
	private String columns = "{field:'id',title:'资源ID',width:70},{field:'name',title:'资源名称',width:100},{field:'remarks',title:'备注',width:100}";
	...
	public int doStartTag() throws JspException {
		try {
			...
			if(ObjUtil.isEmpty(toolbarId)){
				...
				htmlStr.append("<button class=\"operate-btn mr5\" type=\"button\" onclick=\"$('#"+id+"').combogrid('grid').datagrid('load',{name:$('#"+id+"_userName').val()});\">查询</button>");
				...
				htmlStr.append("</dd><dd><label class=\"lab\" style=\"width:60px;\">资源名称:</label><input id=\""+id+"_userName\" style=\"width:100px; height:22px;\" type=\"text\"/>");
