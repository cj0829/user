 ...
 */
@Entity
@Table(name = "u_UserStrategy")
@DynamicInsert(true)
@DynamicUpdate(true)
@Comment(ch = "用户策略表",en="pmt_common_UserStrategy")
public class UserStrategy extends FlowStrategy {
	...
	private Long id;
	/** 导入用户是否需要审批 */
	private Integer isImport = YesorNo.NO.intValue();
	...
	@Column(name = "isImport", nullable = false)
