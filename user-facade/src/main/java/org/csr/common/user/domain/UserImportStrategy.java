 ...
 */
@Entity
@Table(name = "u_UserImportStrategy")
@DynamicInsert(true)
@DynamicUpdate(true)
@Comment(ch = "用户策略表",en="pmt_common_UserImportStrategy")
public class UserImportStrategy extends FlowStrategy {
